...
import MessageScreen from 'screens/privateScreens/Messenger/MessageScreen.tsx';
...
const MessengerStack = () => {
    ...
    return (
        ...
        >
            ...
            <Stack.Screen options={{ title: 'Message' }} name={ROUTES.MESSAGE_SCREEN} component={MessageScreen} />
        </Stack.Navigator>
    );
};
